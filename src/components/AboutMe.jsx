  ...
  return (
    <div className="about-me-container">
      <div className="highlight-container">
        <div className="highlight-image" style={{backgroundImage: `url(/images/projects/colinkz1.jpg)`}}></div>
      ...
      <div className="highlight-container">
        ...
        <div className="highlight-image" style={{backgroundImage: `url(/images/resume-jumbo.jpg)`}}></div>
      </div>

      <div className="highlight-container">
        <div className="highlight-image" style={{backgroundImage: `url(/images/projects/colinkz2.jpg)`}}></div>
        <div className="highlight-content">
